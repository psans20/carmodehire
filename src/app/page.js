...
<div class="max-w-sm p-6 bg-[#0E3047] flex flex-col items-center justify-center space-y-10">
    ...
    <p class={`mb-3 font-normal text-white ${oswald.className}`}>
    Feel free to reach out to us right away by dialing our phone number: 07715 249278		</p>
    <a href='tel:07715249278' class={`inline-flex items-center text-white ${oswald.className}`}>
