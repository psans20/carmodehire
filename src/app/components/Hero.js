...
<a href='tel:03335770272'><button className={`rounded-full border-2 border-blue-800 text-blue-800 font-semibold px-8 py-2 flex text-lg hover:bg-blue-800 hover:text-white duration-300 ${oswald.className}`}><FaPhone className='mr-4 mt-1'/>Book Sport Car Today</button></a>
