...
<h2 className={`font-bold text-5xl ${oswald.className}`}>0330 098 5257</h2>
<h2 className={`font-semibold text-md ${questrial.className}`}>Call or Send Whatsapp inquiry</h2>
<a href='tel:03300985257'><button className={`rounded-full border-2 border-blue-800 text-blue-800 font-semibold px-8 py-2 flex uppercase hover:bg-blue-800 hover:text-white duration-300 ${oswald.className}`}><FaPhone className='mr-4 mt-1'/>call for a booking</button></a>
