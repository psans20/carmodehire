...
At GTR Hire, we take pride in delivering a seamless and reliable experience for our clients. Our commitment to excellence is reflected not only in the quality of our vehicles but also in our efficient delivery and collection service, which spans across the entirety of the UK.
      ...
      <div id="cars" className="flex flex-col md:grid md:grid-cols-3 md:space-x-8">
        {cars.map((car) => (
          <div className="flex flex-col items-center justify-center font-sans mb-8" key={car.ID}>
            <img src={car.Thumbnail} className="h-80 w-96 object-cover" alt={car.Name} />
            ...
            <div className={`flex flex-col items-center justify-center gap-2 text-center md:space-y-0 lg:flex-row xl:flex-row ${questrial.className}`}>
